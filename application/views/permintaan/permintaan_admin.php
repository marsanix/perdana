            ...
            <div class="box-header with-border" style="min-height: 40px">
              ...
              <?php echo form_open('permintaan/load_data', array('name' => 'frmSearchData', 'id' => 'frmSearchData', 'role' => 'form', 'style' => 'display: none;' )); ?>
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <select name="cari_perusahaan" id="cari_perusahaan" class="form-control input-sm" style="width: 250px;">
                  ...
                  <div class="form-group">
                    <select name="cari_pengguna" id="cari_pengguna" class="form-control input-sm" style="width: 250px;">
                      <option value="">- Nama Pengguna- </option>
                      <?php if(!empty($penggunaList)) { ?>
                      <?php foreach($penggunaList as $pengguna) { ?>
                      <option value="<?php echo $pengguna->id ?>"><?php echo $pengguna->name ?></option>
                      <?php } ?>
                      <?php } ?>
                    </select>
                  </div>
                  ...
                  <div class="checkbox">
                    <label>
                      <input name="cari_status_proses" type="checkbox" value="0" checked> Proses
                    </label>&nbsp;&nbsp;
                    <label>
                      <input name="cari_status_selesai" type="checkbox" value="1" checked> Sudah Selesai
                    </label>
                  </div>
                  <?php } else { ?>
                    <input type="hidden" name="cari_status" value="<?php echo $status ?>" />
                  <?php } ?>
                  <div class="form-group">
